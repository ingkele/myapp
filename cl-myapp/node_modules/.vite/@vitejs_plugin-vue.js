...
var require_dist = __commonJS({
  "node_modules/@vitejs/plugin-vue/dist/index.js"(exports, module) {
    ...
    var require_constants = __commonJS2({
      "../../node_modules/.pnpm/picomatch@2.3.0/node_modules/picomatch/lib/constants.js"(exports2, module2) {
        "use strict";
        var path4 = (init_path(), path_exports);
        var WIN_SLASH = "\\\\/";
    ...
    var import_fs2 = __toModule((init_fs(), fs_exports));
    var import_path = __toModule((init_path(), path_exports));
...
@vitejs/plugin-vue requires vue (>=3.2.13) or @vue/compiler-sfc to be present in the dependency tree.`);
    ...
    var import_querystring = __toModule((init_querystring(), querystring_exports));
    ...
    var import_fs = __toModule((init_fs(), fs_exports));
    var import_path2 = __toModule((init_path(), path_exports));
    ...
    var import_path3 = __toModule((init_path(), path_exports));
...
import.meta.hot.accept(({ render }) => {
    ...
    var import_querystring2 = __toModule((init_querystring(), querystring_exports));
    var import_path4 = __toModule((init_path(), path_exports));
    ...
    var import_vite = __toModule(require_node());
...
`;
    ...
    async function transformStyle(code, descriptor, index, options, pluginContext) {
      ...
      const result = await options.compiler.compileStyleAsync(__spreadProps(__spreadValues({}, options.style), {
...
var vitejs_plugin_vue_default = require_dist();
export {
